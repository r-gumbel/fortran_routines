...
!----------------------------------------------------------------------------------------
    ...
    real(wp), intent(in) :: x
    antiF = 1.0_wp/3.0_wp * x**3 - x**2 + 4.0_wp * x
    end function antiF

!----------------------------------------------------------------------------------------
!   SUBROUTINE TO CALCULATE INTEGRAL USING COMPOSITE TRAPEZOIDAL METHOD
!----------------------------------------------------------------------------------------
    subroutine trap(xmin, xmax, dx, area, N)
